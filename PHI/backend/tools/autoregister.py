...
def get_context_optimizer_tools():
    ...
    return [
        ...
        _make_tool("compress_tool_list", "Generate a compressed tool description grouped by relevant categories", {"type": "object", "properties": {"categories": {"type": "string", "description": "Comma-separated category names"}, "tools_json": {"type": "string", "description": "Optional JSON-encoded tool list"}}, "required": ["categories"]}, compress_tool_list, "utility"),
