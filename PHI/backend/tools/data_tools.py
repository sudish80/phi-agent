...
def get_data_tools():
    return [
        ...
        for n, d, p, h in [
            ...
            ("str_truncate", "Truncate string to max length with ellipsis", {"type":"object","properties":{"text":{"type":"string"},"max_len":{"type":"integer"}},"required":["text","max_len"]}, str_truncate),
            ...
            ("str_capitalize", "Capitalize first letter of each word", {"type":"object","properties":{"text":{"type":"string"}},"required":["text"]}, str_capitalize),
            ...
            ("list_chunk", "Split list into chunks of size N", {"type":"object","properties":{"items":{"type":"array"},"size":{"type":"integer"}},"required":["items","size"]}, list_chunk),
            ("list_flatten", "Flatten nested lists one level", {"type":"object","properties":{"items":{"type":"array"}},"required":["items"]}, list_flatten),
            ("list_unique", "Remove duplicates preserving order", {"type":"object","properties":{"items":{"type":"array"}},"required":["items"]}, list_unique),
            ...
            ("list_shuffle", "Shuffle list randomly", {"type":"object","properties":{"items":{"type":"array"}},"required":["items"]}, list_shuffle),
            ("list_sample", "Pick N random items from list without replacement", {"type":"object","properties":{"items":{"type":"array"},"n":{"type":"integer"}},"required":["items"]}, list_sample),
            ("list_rotate", "Rotate list by N positions", {"type":"object","properties":{"items":{"type":"array"},"n":{"type":"integer"}},"required":["items"]}, list_rotate),
